...
public class EventQueue<EventMessage> implements Serializable, Iterable<EventMessage> {
     ...
     */
    public void enqueue(EventMessage item) {
        Node oldlast = last;
        last = new Node();
        last.item = item;
        last.next = null;
     ...
     * @throws java.util.NoSuchElementException if this queue is empty
     */
    public EventMessage dequeue() {
        if (isEmpty()) throw new NoSuchElementException("Queue underflow");
        EventMessage item = first.item;
        first = first.next;
        N--;
    ...
    private class ListIterator implements Iterator<EventMessage> {
        ...
        public EventMessage next() {
            ...
            EventMessage item = current.item;
